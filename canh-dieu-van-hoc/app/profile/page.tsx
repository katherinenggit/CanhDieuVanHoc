            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <div className="flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-pink-400 to-red-500 text-2xl font-bold text-white">
                    {profile.display_name[0].toUpperCase()}
                  </div>
                  <div>
                    <CardTitle className="text-2xl">{profile.display_name}</CardTitle>
                    <CardDescription>@{profile.username}</CardDescription>
                    <div className="mt-2 flex items-center space-x-2 text-green-800">
                      <Badge className={getBadgeColor(profile.badge)}>{profile.badge}</Badge>
                      <span className="text-sm font-semibold text-primary text-purple-600"> 
                        Level {currentLevel}
                      </span>
                    </div>
                  </div>
